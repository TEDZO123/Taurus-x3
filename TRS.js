...
module.exports = bosco = async (bosco, mek) => {
	try {
       ...
       const catlo = (teks) => {
        ...
        const grupinv = (teks) => {
        	grup = bosco.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '120363042182512544@g.us', "inviteCode": 'https://chat.whatsapp.com/JCDXgSphA49EHxjPn813IL', "groupName": `taurus`, "footerText": "*taurus*", "jpegThumbnail": dfrply, "caption": teks}}, {quoted:fvideo})
      ...
      const fgclink = (teks) => {
            bosco.sendMessage(from, teks, text, {
                quoted: {
	              ...
	              message: {
		               "groupInviteMessage": {
			               "groupJid": "120363042182512544@g.us",
...
/}*/
        ...
        //FAKEREPLY PRODUCT
            ...
            const fgc = {
                  key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "120363042182512544@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `${fake}`, 'jpegThumbnail': fs.readFileSync('./ds.jpg')}}}
            //FAKEREPLY GIF
            const fgif = {
...
//------------------< Bot Owner >-------------------
       ...
       case 'group':
        rows = [
          ...
          section = [{title: "sᴜʙsᴄɪʙᴇ ʏᴛ ᴛᴀᴜʀᴜs ᴇᴅɪᴛs ғᴏʀ ᴍᴏʀᴇ ᴜᴘᴅᴀᴛᴇs", rows: rows}]
