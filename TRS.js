...
ᴛᴀᴜʀᴜs
 ...
 break
    case 'help':
        rows = [
           {title: '𝐎𝐖𝐍𝐄𝐑 𝐌𝐄𝐍𝐔', description: "", rowId: `prefix+'ownermenu'`},
           {title: '𝐒𝐓𝐎𝐑𝐀𝐆𝐄 𝐌𝐄𝐍𝐔', description: "", rowId: `prefix+'storagemenu'`},
           {title: '𝐄𝐗𝐓𝐑𝐀 𝐌𝐄𝐍𝐔', description: "", rowId: `prefix+'extramenu'`}]
           {title: '𝐆𝐀𝐌𝐄', description: "", rowId: `prefix+'slot'`}]
           {title: '𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃 𝐌𝐄𝐍𝐔', description: "", rowId: `prefix+'downloadmenu'`}]
           {title: '𝐑𝐔𝐋𝐄𝐒', description: "", rowId: `prefix+'rules'`}]
           {title: '𝐄𝐃𝐈𝐓 𝐌𝐄𝐍𝐔', description: "", rowId: `prefix+'editmenu'`}]
           {title: '𝐆𝐑𝐎𝐔𝐏 𝐌𝐄𝐍𝐔', description: "", rowId: `prefix+'groupmenu'`}]
           {title: '𝐌𝐀𝐊𝐄𝐑 𝐌𝐄𝐍𝐔 1', description: "", rowId: `prefix+'makermenu'`},  
           {title: '𝐌𝐀𝐊𝐄𝐑 𝐌𝐄𝐍𝐔 2', description: "", rowId: `txtit`}]   
          section = [{title: "jmn+_0x893b24(0xe2)+week+_0x893b24(0xe2)+calender", rows: rows}]
          button = {buttonText: '𝐂𝐋𝐈𝐂𝐊 𝐇𝐄𝐑𝐄', description: `\n\n▶ *ʜɪ :* @ \n\n▶ 🦋 𝐓 𝐀 𝐔 𝐑 𝐔 𝐒 🦋 ◀`,
          sections: section, listType: 1}
          bosco.sendMessage(from, button, MessageType.listMessage, {{'quoted':ftrol,'caption':'hehe','[_0x893b24(0xdc)](sender['split']('@')[0x0]+'@s.whatsapp.net');}contextInfo':{'mentionedJid':[sender]}});
                    break
